...
const checkPasswordValidation = document.getElementById("checkPasswordValidation");
...
function validateCheckPassword() {
    if(password.value.length >= 4 && password.innerText == checkPassword.innerText) {
...
submit.onclick = () => {
    ...
    if(nameValidation.style.color == "green" && emailValidation.style.color == "green" && ageValidation.style.color == "green" && passwordValidation.style.color == "green" && checkPasswordValidation.style.color == "green")
